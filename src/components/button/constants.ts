...
export const BUTTON_THEMES: ButtonThemes = {
  ...
  solid: {
    danger: 'bg-danger-900 text-neutral-100 hover:bg-danger-700',
    neutral: 'bg-neutral-900 text-neutral-100 hover:bg-neutral-700',
    primary: 'bg-primary-900 text-neutral-100 hover:bg-primary-700',
    secondary: 'bg-secondary-900 text-neutral-100 hover:bg-secondary-700',
    success: 'bg-success-900 text-neutral-100 hover:bg-success-700',
    warning: 'bg-warning-900 text-neutral-100 hover:bg-warning-700',
  },
} as const
